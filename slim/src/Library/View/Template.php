...
class View {
    ...
    public function render($template, $data = null) {
        ...
        extract($data);
        ob_start();
        require '/var/www/html/trabajo/explosivos/branches/version3.0/slim/src/templates/layout.php';
        require $templatePathname;
        require '/var/www/html/trabajo/explosivos/branches/version3.0/slim/src/templates/footer.php';
        return ob_get_clean();
    }
